...
AUR=( autokey bluej cutycapt-svn gimp-extras gtk-theme-plastiq google-chrome-dev google-earth hotot-gtk2 iolanguage-git lib32-nss-mdns lightning-bin mrxvt nuvolaplayer perl-audio-flac-header perl-cgi-ex perl-cpanplus-dist-arch-git perl-critic perl-dbd-csv perl-gnome2-vte perl-html-query gtk-theme-plastiq perl-net-xwhois perl-rpc-xml perl-www-curl-simple perl-www-wikipedia psx qbittorrent-bin rbwebkitgtk-git rxvt-unicode-patched tclxosd ttf-mac-fonts ttf-ms-fonts ttf-vista-fonts xscreensaver-goban );
