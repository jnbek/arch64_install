...
AUR=( autokey cutycapt-svn gimp-extras google-chrome-dev google-earth hotot-gtk2 lib32-nss-mdns lightning-bin mrxvt rhythmbox-tray-icon-git nuvolaplayer perl-audio-flac-header perl-cgi-ex perl-cpanplus-dist-arch-git perl-critic perl-dbd-csv perl-devel-repl perl-gnome2-vte perl-html-query gtk-theme-plastiq perl-net-xwhois perl-rpc-xml perl-www-curl-simple perl-www-wikipedia psx qbittorrent-bin rhythmbox-equalizer-git rxvt-unicode-patched tclxosd ttf-mac-fonts ttf-ms-fonts ttf-vista-fonts xscreensaver-goban nodejs-uglify-js nodejs-jshint nodejs-recess );
